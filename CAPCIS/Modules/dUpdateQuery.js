		...
		case 3: //referals
			switch(myObject.minor){
				case 0: answer =  'UPDATE capcis.assessorinformation SET AssessorName = "'+myObject.data1+'", AssessorPhone = "'+myObject.data2+'", \
 						...
 						AssPreferredReportingMethod = "'+myObject.data13+'", FK_FXuseraccounts_FXUserAccountsID = "'+myObject.id+'", InactiveAssessorInfo = '+myObject.data15+' \
				...
				case 3: answer =  'UPDATE capcis.attorneyinformation SET AttorneyName = "'+myObject.data1+'", AttorneyPhone = "'+myObject.data2+'", \
 						...
 						AttorneyState = "'+myObject.data7+'", AttorneyZipCode = "'+myObject.data8+'", AttorneyPhoneExt= "'+myObject.data9+'", FK_fxuseraccounts_FXUserAccountsID ="'+myObject.id+'", \
