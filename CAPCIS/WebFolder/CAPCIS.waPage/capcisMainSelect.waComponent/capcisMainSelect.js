...
function constructor (id) {
	...
	function pageOpener (id) 
	{
	    ...
	    getSubTabButton.style.left = "77px";
	    ...
	    var getSubTabX = document.getElementById("capcisMainWC_stc" + mainTabNumber.toString() + subTabNumber.toString());
	    getSubTabX.style.top = subColumnPosTop[subColumnNumber] + "px";
	    getSubTabX.style.left = "77px";
